...
import { ArrowLeft, CheckCircle2, X, Mail, Lock, User } from "lucide-react";
        ...
        <div className="space-y-8">
          <div className="text-center space-y-3">
            ...
            <p className="text-muted-foreground text-lg">
              Create your account and tell us about your services
            </p>
          </div>
          ...
          <Card className="p-8">
            <Form {...form}>
              <form onSubmit={form.handleSubmit(onSubmit)} className="space-y-6">
                ...
                >
                  {mutation.isPending ? "Creating Account..." : "Create Account & Join Network"}
                </Button>
